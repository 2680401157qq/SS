...
<form class="layui-form" style="width: 80%;">
    ...
    <input type="hidden" name="classId" value="${aClass.classId}"/>
    <div class="layui-form-item">
        <label class="layui-form-label ">班级名称</label>
        <div class="layui-input-block">
            <input type="text" id="className" class="layui-input"
                   lay-verify="required" placeholder="请班级名称" name="className" value="${aClass.className}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="classNote" id="nickname" class="layui-input"
                   lay-verify="required" placeholder="请输入备注" value="${aClass.classNote}">
        </div>
    </div>
